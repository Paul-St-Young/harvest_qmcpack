...
def collect_mean_df(folder,nequil,kappa,tmp_dat):
  """ collect all scalar.dat files in folder
  ...
  * this routine should be superseded by collect_flist

  Args:
    folder (str): the folder that contains the scalar.dat files
